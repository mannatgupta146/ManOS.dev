    ...
    <>
      ...
      <nav>
        <div className="left">
          ...
          <span className="left-name">Mannat Gupta</span>
          ...
          <div className="connect-wrapper">
            ...
            >
              Connect
              <span className={`arrow ${showConnect ? "open" : ""}`}><i class="ri-arrow-up-s-line"></i></span>
            </button>

            {showConnect && (
            <div className="connect-dropdown">
              <a href="https://instagram.com/mannat_1411" target="_blank" rel="noopener noreferrer">
                <span>Instagram</span>
