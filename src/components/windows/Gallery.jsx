...
const Gallery = ({ minimized, onClose, onMinimize, zIndex, onFocus }) => {
  ...
  return (
    <MacWindow appId="gallery" title="Gallery" minimized={minimized} onClose={onClose} onMinimize={onMinimize} zIndex={zIndex} onFocus={onFocus}>
